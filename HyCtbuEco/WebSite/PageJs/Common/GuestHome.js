function GuestHomeRunPage() {
    ...
    viewModel.executeIndicatData = function () {
        ...
        if (params.IndicatorIds.length <= 0) {
            ...
            $.ajax({
                url: '/WebApi/GuestAllData/QueryData',
                type: "post",
                dataType: "json",
                traditional: true,
                ...
                success: function (data) {
                    ...
                    if (data != null) {
                        ...
                        //如果DataTable没有被初始化，初始化DataTable
    ...
    viewModel.exportToExcel = function () {
        ...
        $.download('/WebApi/GuestAllData/PostDataToExcel?libId=' + libId, 'find=commoncode', 'post');
    ...
    viewModel.executeFormatRowsAndCols = function () {
        ...
        if (params.IndicatorIds.length <= 0) {
            ...
            $.ajax({
                url: '/WebApi/GuestAllData/QueryDataFormat',
                type: "post",
                dataType: "json",
                traditional: true,
                data: { libId: libId, "indiactorArray": params.IndicatorIds, "areaArray": params.AreaIds, "timeArray": params.TimeIds },
    ...
    viewModel.executeGraphics = function () {
        ...
        if (params.IndicatorIds.length <= 0) {
            ...
            $.ajax({
                url: '/WebApi/GuestAllData/SaveParamToSession',
                type: "post",
                dataType: "json",
                traditional: true,
                ...
                success: function (data) {
                    if (data == 1) {
                        window.location.hash = "/Guest/GuestMakeGraphics?libID=" + libId;
                    } else {
                        alert("服务器错误");
                    }
                }
