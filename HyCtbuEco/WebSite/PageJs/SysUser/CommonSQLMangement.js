...
function RunPage() {
    ...
    options = {
        ...
        headers: [
            ...
            { displayText: 'SQL语句', value: 'SSqlStr', width: 'auto' },
        ...
        dataQueryUrlAccessor: function () {
            return "/api/CommonDataExport/Search";
        },
        AddBefore: function () {
            //表单发送前的函数
            return true;
        ...
        dataAddUrlAccessor: function () {
            this.NodeValue().ICreateID = $("#HiddenUserID").val();
            return "/api/SqlQuery/Post";
        },
        dataUpdateAccessor: function (key) {
            return "/api/SqlQuery/Put/" + key;
        },
        dataNodeSelect: function (id) {
            return "/api/SqlQuery/get/" + id;
        },
        ...
        dataDeleteAccessor: function (data) {
            ...
            if (userIDs != "") {
                return appendQueryString("/api/CommonDataExport/DeleteSQL", { ids: userIDs });
            } else
                return "";
    ...
    options.frmElement.validate({
        rules: {
            ...
            txtbID: { required: true, digits: true }, txtbSSqlName: { maxlength: 50 }, txtbSSqlStr: { maxlength: 50 }, txtbICreateID: { digits: true }, txtbDCreate: { date: true }, txtbISort: { digits: true }
        ...
        messages: {
            ...
            txtbID: { required: '必填项', digits: '必须是整数' }, txtbSSqlName: { maxlength: '最大长度为25' }, txtbSSqlStr: { maxlength: '最大长度为2000' }, txtbICreateID: { digits: '必须是整数' }, txtbDCreate: { date: '必须是日期格式，例如：2013/01/01' }, txtbISort: { digits: '必须是整数' }
