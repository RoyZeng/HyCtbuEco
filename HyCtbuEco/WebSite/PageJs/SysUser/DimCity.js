...
function DimCityRunPage() {
    ...
    options = {
        ...
        NodeValue: ko.observable( {
            ...
            Id:0,SAddireName:'',IParentID:0,ILevel:0,SCode:'',SPostCode:''
						
        } ),

        //用户查询URL
        dataQueryUrlAccessor: function () { return "/api/City/TreeAll"; },

        //添加用户URL
        dataAddUrlAccessor: function ( key ) { return "/api/City/AddTreeNode/" + key; },
        dataUpdateAccessor: function ( key ) { return "/api/City/Put/" + key; },
        dataDeleteAccessor: function ( key ) {


            return "/api/City/DelTreeNode/" + key;

        },
        dataNodeSelect: function ( id ) {
            return "/api/City/get/" + id;
        }
