...
public class ImageHelper
{
    ...
    /// 读取指定图像文件，并从指定位置开始裁减
    /// </summary>
    /// <param name="oldImageFile">旧图像的物理位置</param>
    /// <param name="fileSaveUrl">新图像的位置</param>
    /// <param name="x"></param>
    /// <param name="y"></param>
    /// <param name="x2"></param>
    /// <param name="y2"></param>
    /// <returns></returns>
    public static bool CropFromImage(string oldImageFile, string fileSaveUrl, int x, int y, int x2, int y2)
    {
        //读取指定图像文件，并从指定位置开始裁减

        System.Drawing.Image srcBitmap = Bitmap.FromFile(oldImageFile);

        System.Drawing.Image templateImage = new System.Drawing.Bitmap(x2 - x, y2 - y);
        System.Drawing.Graphics templateG = System.Drawing.Graphics.FromImage(templateImage);
        templateG.InterpolationMode = System.Drawing.Drawing2D.InterpolationMode.High;
        templateG.SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.HighQuality;
        templateG.Clear(Color.White);
        templateG.DrawImage(srcBitmap, new System.Drawing.Rectangle(0, 0, x2 - x, y2 - y), new System.Drawing.Rectangle(x, y, x2 - x, y2 - y), System.Drawing.GraphicsUnit.Pixel);
    ...
    /// <param name="postedFile">原图HttpPostedFile对象</param>
    /// <param name="fileSaveUrl">保存路径,物理地址</param>
    ...
    /// <summary>
    /// 将原始的图像生成为_s的header 图
    /// </summary>
    /// <param name="orgUrl"></param>
    public static string getHeaderUrl(string orgUrl){
        string newUrl = "";
        if (!string.IsNullOrEmpty(orgUrl))
        {
            string[] tmpSt = orgUrl.Split('.');
            int count=tmpSt.Length;
